...
begin
    ...
    with sold_rows as (
        ...
        set sold_at = sold_time,
            sold_for_berries = public.user_fish_catches.sell_value * sale_multiplier
        ...
        returning public.user_fish_catches.sold_for_berries
    )
    select count(*)::integer, coalesce(sum(sold_for_berries), 0)::bigint
